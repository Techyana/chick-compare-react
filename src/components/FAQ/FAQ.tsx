...
const faqs: FAQItem[] = [
  {
    question: 'What is Cheap-Compare?',
    answer: 'Cheap-Compare is your go-to platform for comparing deals on insurance, phone plans, fibre deals, and more. We help you find the best offers from top providers.'
  },
  {
  ...
  {
    question: 'Is Cheap-Compare free to use?',
    answer: 'Yes, using Cheap-Compare is completely free! Our goal is to help you save money by finding the best deals available.'
  },
  {
  ...
  {
    question: 'Can I contact a provider directly through Cheap-Compare?',
  ...
  return (
    <section id="faq" className="py-8 bg-gray-100">
      <div className="container mx-auto">
        <h2 className="text-center text-3xl font-bold mb-8">Frequently Askedr 
           Questions</h2>
