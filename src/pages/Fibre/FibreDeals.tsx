...
const isps = [
  { name: 'Axxess', price: 'R599', speed: '100Mbps', link: '/fibre/axxess', logo: '/assets/logos/axxess-logo.png' },
...
const FibreDeals: React.FC = () => {
  return (
    <div className="relative h-screen mt-20">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(/assets/images/logos/Axxess-logo.webp)' }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full p-4">
        ...
        >
          ...
          <div className="flex justify-center mb-4">
            <img src="/public/assets/logos/Axxess-logo.webp" alt="Fibre Icon" className="w-24 h-24 rounded-full border-4 border-teal-500" />
          </div>
          <ul className="space-y-4">
            {isps.map((isp, index) => (
              ...
              >
                ...
                <Link to={isp.link} className="text-teal-700 hover:text-teal-900">
                  Compare
                </Link>
              </motion.li>
            ))}
